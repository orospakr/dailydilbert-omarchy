...
// Bar pill for the daily Dilbert strip. Mirrors the contract the first-party
// weather widget implements: the bar tracks THIS item as the panel identity
...
BarWidget {
  ...
  BarIconButton {
    ...
    anchors.fill: parent
    bar: root.bar
    text: String(root.setting("icon", "󰊪"))  // nf-md-glasses
